...
#define SAMPLES_PER_SECOND 1000  //Set by the watchdog timer interval	
	
#define SENSOR_IMPACT_RATIO 1.5 //The upper threshold for impact based on the average
...
#define CONTACT_TIME_MS_PER_COUNT 2
#define CONTACT_TIME_2MS_PER_SAMPLE (CONTACT_TIME_MS_PER_COUNT * 1000 / SAMPLES_PER_SECOND)

#define CONTACT_TIME_MAX_CONTACT (256 * CONTACT_TIME_2MS_PER_SAMPLE)
	
#define AIR_TIME_MS_PER_COUNT 1
#define AIR_TIME_MS_PER_SAMPLE (AIR_TIME_MS_PER_COUNT * 1000 / SAMPLES_PER_SECOND)
